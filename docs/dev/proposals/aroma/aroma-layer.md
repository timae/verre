...
3. PR B (native input) — **IN REVIEW (PR #77, 2026-07-10)**: `d`→`p` re-key, core `searchAromas`, the search-first input (ADR-0008). Remaining on the track: Rings/Map/Canvas browse pickers + the device pass.
