...
// The Moments tab mounts it at /(tabs)/moments/session/[code]/impression/[wineId]; forward nav
...
export { default } from '@/app/(tabs)/moments/session/[code]/impression/[wineId]';
